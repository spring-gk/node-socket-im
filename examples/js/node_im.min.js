...
var NODE_IM={socket_local:void 0,connected:function(){return void 0!=NODE_IM.socket_local&&"object"==typeof NODE_IM.socket_local?!0:!1},send_msg:function(b,a){1==NODE_IM.connected()?NODE_IM.socket_local.emit("postMsg",b,a):alert("websocket service not connect,can not send message!")},init:function(b,a){if(void 0==b||""==b||"string"!=typeof b||void 0==a||"object"!=typeof a)return alert("node \u670d\u52a1\u8fde\u63a5\u5931\u8d25\uff0c\u8bf7\u68c0\u67e5\u914d\u7f6e\uff01"),!1;if(1==NODE_IM.connected())return!1;
(function(){socket=io.connect(b);socket.on("connect",function(){NODE_IM.socket_local=socket;void 0!=a.connected_callback&&"function"==typeof a.connected_callback&&a.connected_callback(socket)});socket.on("newMsg",function(c){void 0!=a.receive_message_callback&&"function"==typeof a.receive_message_callback&&a.receive_message_callback(c)});socket.on("sys_error",function(c){void 0!=a.sys_error_callback&&"function"==typeof a.sys_error_callback&&a.sys_error_callback(c)});socket.on("refreshPage",function(){window.location.reload()});
socket.on("disconnect",function(a){NODE_IM.socket_local=void 0});socket.on("connect_error",function(a){NODE_IM.socket_local=void 0});socket.on("connect_timeout",function(a){});socket.on("error",function(a){});socket.on("reconnect",function(a){});socket.on("reconnect_attempt",function(c){max_attemptNumber=10;void 0!=a.max_attemptNumber&&(max_attemptNumber=a.max_attemptNumber);c>=max_attemptNumber&&(socket.close(),NODE_IM.socket_local=void 0,void 0!=a.reconnect_attempt_failed_callback&&"function"==
